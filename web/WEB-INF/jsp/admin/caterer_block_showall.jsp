...
<html>
    ...
    <body onload="setCatererId();">
        ...
        <a href="${pageContext.request.contextPath}/managercaterer/listCaterers.htm">Block Caterer</a>
        <table border="1">
            <tr>
                <td>Caterer Name</td>
                <td>Email</td>
            ...
            <c:forEach items="${caterersblock}" var="caterer">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/managercaterer/active/${caterer.accounts.id}.htm"> Active</a></td>
                </tr> 
            </c:forEach>
        </table>
    </body>
